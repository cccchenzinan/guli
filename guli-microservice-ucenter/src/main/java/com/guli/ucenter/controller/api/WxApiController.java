...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "imcccchenzinan";//为了让大家能够使用微信回调跳转服务器，这里填写你在ngrok的前置域名
    ...
    @GetMapping("callback")
    public String callback(String code, String state, HttpSession session, HttpServletResponse response, HttpServletRequest request) {
        ...
        // 登录
        // 生成jwt
        String guliJwtToken = com.guli.ucenter.util.JwtUtils.generateJWT(member);
        // 存入cookie，超时时间30分钟
